...
| Continually Self-Improving Robots，CoRL workshop | 2026-11-12 | 至多 8 页正文，任意学术模板，双盲、非归档；所查页面未列具体截止日期 | RSI 更贴近主题，但自动更新实验尚未完成 |
...
- 尚缺：第三种任务、真实视觉、完整任务的多次判断、独立确认性复验、完整自动 RSI 数据更新及等预算对照。
